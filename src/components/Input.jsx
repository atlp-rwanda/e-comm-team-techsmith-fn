    ...
    return (
      <div className='relative w-full'>
        <input
          ...
          className={`${className} w-full block px-4 py-4 text-sm text-${color} bg-${backgroundColor} rounded-lg border-1 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 peer`}
