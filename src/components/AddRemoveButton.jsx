  ...
  return (
    <div>
      <div className='inline-flex space-x-1'>
        <button
          type='button'
          className='hover:bg-[rgb(36,54,101)] hover:text-white cursor-disabled px-3 py-2 border'
          onClick={() => {
        ...
        <button
          type='button'
          className='hover:bg-[#243665] hover:text-white cursor-disabled px-3 py-2 border'
          disabled
          onClick={() => {
