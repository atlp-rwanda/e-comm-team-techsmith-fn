...
import { useDeleteProductMutation, useUpdateProductMutation } from "../states/api/apiSlice";
                  ...
                  !updating ?
                    ...
                    <div className='updateForm text-start'>
                      ...
                      <div className='inputs'>
                        ...
                        <div className='inputs'>
                          <select name="categoryId"
                           ...
                           {...register('categoryId')}
                           >
                            <option value={items[0].categoryId}>Select product category</option>
                     ...
                     <div className='flex updateForm_Product'>
                          ...
                          <textarea  id="" cols="30" rows="10" defaultValue={items[0].description}
                          name="description"
                          {...register('description')} style={{backgroundColor:"#eee",border:"none",fontSize:"1.5rem",padding:"1.7rem 0.7rem 1rem 0.8rem"}}/>
                      </div>
